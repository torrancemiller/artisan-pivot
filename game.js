...
console.log('🎮 Initializing Artisan Pivot game...');
...
function preload() {
    ...
    // Use relative paths for Laravel Cloud deployment
...
function create() {
    ...
    try {
        ...
        this.input.on('pointerup', () => {
         ...
         // Create UI background panel for better organization
         const uiPanel = this.add.graphics();
         uiPanel.fillStyle(0x1a0a2e, 0.8);
         uiPanel.lineStyle(2, colors.neonCyan, 0.6);
         uiPanel.fillRoundedRect(630, 30, 150, 150, 10);
         uiPanel.strokeRoundedRect(630, 30, 150, 150, 10);

         // Add futuristic UI elements - repositioned to avoid overlaps
         timerText = this.add.text(650, 50, `⚡ ${Math.floor(timer / 60)}:${(timer % 60).toString().padStart(2, '0')}`, {
             fontSize: '16px',
             fill: '#00ffff',
             fontFamily: 'Orbitron, monospace',
         ...
         levelText = this.add.text(650, 85, `🔮 LEVEL ${currentLevel}`, {
             fontSize: '14px',
             fill: '#ff0080',
             fontFamily: 'Orbitron, monospace',
             backgroundColor: 'transparent',
         ...
         difficultyText = this.add.text(650, 120, `💎 ${levelSettings[currentLevel].difficulty}`, {
             fontSize: '12px',
         ...
         descriptionText = this.add.text(650, 150, `${levelSettings[currentLevel].description}`, {
             fontSize: '10px',
             fill: '#ffffff',
         ...
         const instructionPanel = this.add.graphics();
         instructionPanel.fillStyle(0x0a0a0f, 0.9);
         instructionPanel.lineStyle(2, colors.neonGreen, 0.8);
         instructionPanel.fillRoundedRect(10, 480, 500, 40, 8);
         instructionPanel.strokeRoundedRect(10, 480, 500, 40, 8);

         instructionText = this.add.text(20, 490, `🎯 SEQUENCE: ${levels[currentLevel].join(' → ').toUpperCase()}`, {
             fontSize: '14px',
             fill: '#00ff80',
             fontFamily: 'Rajdhani, sans-serif',
             backgroundColor: 'transparent',
         ...
         // Add futuristic reset button - moved to bottom right with panel
